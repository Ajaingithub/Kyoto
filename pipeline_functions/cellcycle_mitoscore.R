...
#   dev.off()
  ...
  #  Average the expression (after scaling or normalization) of S-phase genes
  #   Average the expression of G2/M-phase genes
  ...
  print(DimPlot(obj, reduction = "pca", group.by= "Phase", split.by = "Phase", raster = TRUE))
  dev.off()
  
  ### not spliting
  pdf(paste(saveDir,"cell_cycle_phase/",samplename,"_",process,"_",Assay,".pdf",sep = ""),width = 8, height = 8)
  print(DimPlot(obj,reduction = "pca",group.by= "Phase", raster = TRUE))
  dev.off()
  ...
  print(DimPlot(obj, reduction = "pca", group.by= "mitoFr", split.by = "mitoFr", raster = TRUE))
  dev.off()
  
  pdf(paste(saveDir,"mitoeffect/",samplename,"_",process,"_",Assay,".pdf",sep = ""),width = 8, height = 6)
  print(DimPlot(obj, reduction = "pca", group.by= "mitoFr", raster = TRUE))
  dev.off()
